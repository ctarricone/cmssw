...
void BtlLocalRecoValidation::bookHistograms(DQMStore::IBooker& ibook,
  ...
  meCluSingCrystalLocalYResZGlobPlus_ =
      ibook.book1D("BtlCluSingCrystalLocalYResZGlobPlus", "BTL cluster local Y resolution (single Crystal clusters, glob Z>0);Y_{RECO}-Y_{SIM} [cm]", 100, -0.2, 0.2);
  meCluSingCrystalLocalYResZGlobMinus_ =
      ibook.book1D("BtlCluSingCrystalLocalYResZGlobMinus", "BTL cluster local Y resolution (single Crystal clusters, glob Z<0);Y_{RECO}-Y_{SIM} [cm]", 100, -0.2, 0.2);

  meCluMultiCrystalLocalYRes_ =
      ibook.book1D("BtlCluMultiCrystalLocalYRes", "BTL cluster local Y resolution (Multi-Crystal clusters);Y_{RECO}-Y_{SIM} [cm]", 100, -0.2, 0.2);
  meCluMultiCrystalLocalYResZGlobPlus_ =
      ibook.book1D("BtlCluMultiCrystalLocalYResZGlobPlus", "BTL cluster local Y resolution (Multi-Crystal clusters, glob Z>0);Y_{RECO}-Y_{SIM} [cm]", 100, -0.2, 0.2);
  meCluMultiCrystalLocalYResZGlobMinus_ =
      ibook.book1D("BtlCluMultiCrystalLocalYResZGlobMinus", "BTL cluster local Y resolution (Multi-Crystal clusters, glob Z<0);Y_{RECO}-Y_{SIM} [cm]", 100, -0.2, 0.2);
  
  meCluCentralLocalYRes_ =
      ibook.book1D("BtlCluCentralLocalYRes", "BTL cluster local Y resolution (central region);Y_{RECO}-Y_{SIM} [cm]", 100, -0.2, 0.2);
  meCluCentralLocalYResZGlobPlus_ =
      ibook.book1D("BtlCluCentralLocalYResZGlobPlus", "BTL cluster local Y resolution (central region, glob Z>0);Y_{RECO}-Y_{SIM} [cm]", 100, -0.2, 0.2);
  meCluCentralLocalYResZGlobMinus_ =
      ibook.book1D("BtlCluCentralLocalYResZGlobMinus", "BTL cluster local Y resolution (central region, glob Z<0);Y_{RECO}-Y_{SIM} [cm]", 100, -0.2, 0.2);

  meCluForwardLocalYRes_ =
      ibook.book1D("BtlCluForwardLocalYRes", "BTL cluster local Y resolution (forward region);Y_{RECO}-Y_{SIM} [cm]", 100, -0.2, 0.2);
  meCluForwardPlusLocalYRes_ =
      ibook.book1D("BtlCluForwardPlusLocalYRes", "BTL cluster local Y resolution (forward region, glob Z>0);Y_{RECO}-Y_{SIM} [cm]", 100, -0.2, 0.2);
  meCluForwardMinusLocalYRes_ =
      ibook.book1D("BtlCluForwardMinusLocalYRes", "BTL cluster local Y resolution (forward region, glob Z<0);Y_{RECO}-Y_{SIM} [cm]", 100, -0.2, 0.2);
  ...
  meCluLocalYPullZGlobPlus_ =
      ibook.book1D("BtlCluLocalYPullZGlobPlus", "BTL cluster local Y pull (glob Z > 0);Y_{RECO}-Y_{SIM}/sigmaY_[RECO]", 100, -5., 5.);
  meCluLocalYPullZGlobMinus_ =
      ibook.book1D("BtlCluLocalYPullZGlobMinus", "BTL cluster local Y pull (glob Z < 0);Y_{RECO}-Y_{SIM}/sigmaY_[RECO]", 100, -5., 5.);
